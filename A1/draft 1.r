...
# The chart shows the relationship between the victims' ages and the times when 
# crimes happened on the street, the most common location in Los Angeles. For 
# both genders, 'F' and 'M,' the victims tend to be younger as it gets later in 
# the day. In contrast, for gender 'X,' the victims are older as the time 
# progresses.
